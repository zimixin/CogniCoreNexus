...
genes = [
    ...
    # --- Пользователь ---
    {"id": "user_dmitry", "name": "Дмитрий Клочков", "type": "person",
     "passport": {"purpose": "Пользователь системы", "domain": "personal", "confidence": 0.99},
     "full_text": "Дмитрий Клочков Александрович, 04.11.1995. Помощник машиниста, ТЧ-17, Абдулино.",
     "tags": ["user", "personal"]},
    {"id": "hobby_dev", "name": "Разработка — хобби", "type": "fact",
     "passport": {"purpose": "Увлечение", "domain": "personal", "confidence": 0.9},
     "full_text": "Android/Termux разработка. Pure Python без нативных зависимостей.",
...
relations = [
    ...
    ("user_dmitry", "uses", "tool_hermes"),
    ("user_dmitry", "creates", "project_nexus"),
